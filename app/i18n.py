...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "figure_fallback_hint": "⚠ 図として認識できなかった内容です（原文ママ・順序は保証されません）",
        ...
        "interpretation_paper_search_placeholder": "論文名で絞り込み",
        ...
        "paper_delete_confirm": "この論文を削除しますか？元のPDF・整形結果・この論文へのメモは削除され、元に戻せません。",
    ...
    "en": {
        ...
        "figure_fallback_hint": "⚠ Content that couldn't be recognized as a figure (verbatim, order not guaranteed)",
        ...
        "interpretation_paper_search_placeholder": "Filter by title",
        ...
        "paper_delete_confirm": "Delete this paper? The original PDF, the formatted result, and its comments cannot be recovered.",
